...
Violant writes to the Pope that some difficulties, *arduis urgentibus*, have occurred in the succession process. 

<div class="audio-player-card">
  {% include audio.html src="/historians-notebook-s1-episodes/audio/" title="Episode 20" %}
</div>
<style>
.audio-player-card {
...
## Today’s Document 
- Subject: Violant writes to the two popes.
