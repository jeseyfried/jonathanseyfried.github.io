...
Violant writes to both popes and reveals that some difficulties, *arduis urgentibus*, have occurred in the succession process. 
...
{% include figure.html
  class="right"
  width="40%"
  caption="ACA CR R1819 f74r [Source: PARES]()"
...
- Place: Barcelona
- Sender: Violant
- Recipients: Pope Clement VII and Pope Urban VI
...
- Corroboration: I did find another letter, on ACA CR R1819 f

- Close-Reading: the presence of the word *publicum* in the second line creates a lot of questions for me - is Violant saying that the difficulties have become known?
