...
thumbnail: /historians-notebook-s1-episodes/images/jan-1-aca-cr-r1952-f5r-joan.jpg
summary: January 1, 1387 
date: 2026-01-01
layout: scrollstory
...
In a move that appears rather vulturous, Joan asks his brother to secure some of their dying father's precious possessions. [^arl1]

[^arl1]:This document was partially transcribed by Antonio Rubió i Lluch and cited by Claire Ponsich. Antonio Rubió y Lluch, Documents per l’historia de la cultura catalana mig-eval (Barcelona: Institut d’Estudis Catalans, 1908), 349 fn1; Claire Ponsich, “Des Lettres, Le Livre et Les Arts Dans Les Relations, Vers 1388-1389, de Violant de Bar et Gaston Fébus, Autour de 1388,” in *Froissart à La Cour de Béarn: L’écrivain*, Les Arts et Le Pouvoir, ed. Valérie Fasseur, 277-304 (Brepols, 2009), 290 fn48.
...
{% include figure.html
  ...
  image-path="/historians-notebook-s1-episodes/images/jan-1-aca-cr-r1952-f5r-joan.jpg"
%}

{% include figure.html
  class="figure"
  width="40%"
  caption="ACA CR R1952 f5v [Source: PARES](https://pares.mcu.es/ParesBusquedas20/catalogo/show/12777462)"
  image-path="/historians-notebook-s1-episodes/images/jan-1-aca-cr-r1952-f5v-joan.jpg"
%}
...
{% include figure.html
  class="right"
  width="40%"
  caption="An astrolabe from the fourteenth century, of Iberian origin [Source: The Aga Khan Museum, AKM611, Planispheric Astrolabe](https://collections.agakhanmuseum.org/collection/artifact/planispheric-astrolabe-akm611)"
  image-path="/historians-notebook-s1-episodes/images/astrolabe.jpg"
%}
...
{% include figure.html
  class="right"
  width="40%"
  caption="An astronomical quadrant from the fourteenth century, of Iberian origin [Source: The British Museum, The Trustees of the British Museum. Shared under a Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0) licence](https://www.britishmuseum.org/collection/object/H_1995-0403-1?selectedImageId=592350001)"
  image-path="/historians-notebook-s1-episodes/images/quadrant.jpg"
%}
...
- This document swoops in to take ownership of royal possessions, even Cordero the dog!
- The document also cements the trust between the two brothers.

## Questions
- What is Joan's connection to Cordero the dog? Is it a famous hunting dog or one that Joan has an emotional connection to?
- Why were the two books mentioned in the letter particularly sought after by Joan?
- Is there any sign of Joan's impending illness in this letter? It appears not.
- Can Pere talk anymore? It seems like this kind of action would not be possible if the king was still concious.
- How will Martí receive this request? Is it reasonable and easy or is Martí going to be annoyed about this?
- Why does Joan know about Sibilla's brother's falcons?
- Does Joan already have knowledge of bezoar stones? Has he seen one before?
- Was Violant involved in the creation of this list of desired possessions from Pere?

## AI Usage
I asked ChatGPT to confirm that 'los stalabres e quadrans' referred to astrolabes and astronomical quadrants. Then I asked it to provide some museum websites to link to object records with photographs. [ChatGPT's search](/historians-notebook-s1-episodes/pdfs/e8-chatgpt-museum-objects.pdf) probably missed some additional good examples, but the ones it found are also good examples.
