...
thumbnail: /historians-notebook-s1-episodes/images/jan-2-aca-cr-r1648-f109r-joan.JPG
summary: January 2, 1387 
date: 2025-12-30
layout: scrollstory
header-image: /historians-notebook-s1-episodes/images/molt-cara-companyona2.png
audio: /historians-notebook-s1-episodes/audio/s1e9-jan2.mp3
tags:
 - Joan
...
<div class="audio-player-card">
  {% include audio.html src="/historians-notebook-s1-episodes/audio/s1e9-jan2.mp3" title="Episode 9" %}
</div>
<style>
.audio-player-card {
...
{% include figure.html
  class="figure"
  width="40%"
  caption="ACA CR R1648 f109r [Source: PARES](https://pares.mcu.es/ParesBusquedas20/catalogo/show/4801202)"
  image-path="/historians-notebook-s1-episodes/images/jan-2-aca-cr-r1648-f109r-joan.JPG"
%}

{% include figure.html
  class="figure"
  width="40%"
  caption="ACA CR R1648 f109v [Source: PARES](https://pares.mcu.es/ParesBusquedas20/catalogo/show/4801202)"
  image-path="/historians-notebook-s1-episodes/images/jan-2-aca-cr-r1648-f109v-joan.JPG"
%}
...
- This document re-enacts the power of elite men to protect perpetrators of sexual assault from facing criminal consequences of rape.
- The document mostly silences the harm done to the victim.

## Questions
- Did Violant know the crime the students were accused of when she wrote her letter on December 25th? It's hard to imagine she did not, but it would be helpful to see if Joan had written an earlier to Montpellier officials.
- Did the fact that Joan's two eldest children were daughters cause him to feel any hesitation in writing to the Duc de Berry? Is social class so powerful that Joan, and Violant as well, consider the status of women in their own family in a way that puts vast distances between them and the woman in this case?
- How frequently was sexual assault reported in Montpellier, or in the Crown of Aragon, at this time? 
- How did the social class of the victim affect the development of events? In a city, would rapists even get arrested in the case of a woman of lower class standing?
- What happened next? Did the students escape punishment?
- Does the archive, possibly in court records from Montpellier, include the voice of the woman or is her voice silenced?

## AI Usage
The difficulty I had with a phrase in the third line led me to put my transcription of this document into ChatGPT. As you can see in [the transcript](/historians-notebook-s1-episodes/pdfs/e9-chatgpt-sexual-assault-montpellier.pdf), it took me a while to get to the meaning of that phrase as terms for young men, possibly with class valences along the lines of modern term hooligans or bullies. However, in tandem with the ChatGPT conversation, I was working with the glossary at the end of *Mediaeval Catalan Linguistic Texts* by Paul Russell-Gebbett. This book's glossary had entries close to 'veylets' and 'masips' and helped me to push back on ChatGPT's initial ideas about these words. I only became aware of this extremely helpful glossary because I browsed the shelf of Catalan language and literature books at Zimmerman Library at the University of New Mexico. The online catalog record for the book does not mention its glossary, so without being physically present in the library, I would not have had a resource that in this moment proved extremely helpful to building my understanding of this document. 
